          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            <div className="inline-block bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              <div className="flex justify-center space-x-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <i key={i} className="fas fa-star text-yellow-400 text-3xl"></i>
                ))}
              </div>
              <div className="text-4xl font-bold text-gray-800 mb-2">5.0</div>
              <div className="text-gray-600 mb-4">{t('reviews-rating')}</div>
                  ...
                  <div key={pageIndex} className="w-full flex-shrink-0">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
                      {displayReviews
                        ...
                        .map((review, index) => (
                        <div key={`${pageIndex}-${index}`} className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-300">
                          {/* Header */}
                          ...
                          <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
                            <span className="text-xs text-gray-500">Postado no Google</span>
