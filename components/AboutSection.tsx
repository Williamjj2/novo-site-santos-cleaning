      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl h-96 flex items-center justify-center text-white">
              <div className="text-center">
                ...
                <p className="text-xl font-semibold">Family-Owned Business</p>
                <p className="text-blue-100">Serving Marietta since day one</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Family-style Service</h3>
            <p className="text-gray-600">Friendly, caring approach with personal attention to detail</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Superior Quality</h3>
            <p className="text-gray-600">Professional excellence and attention to every detail</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Reliable & Punctual</h3>
            <p className="text-gray-600">On time, every time with consistent quality service</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Your happiness guaranteed with every cleaning service</p>
          </div>
        </div>
      </div>
    </section>
